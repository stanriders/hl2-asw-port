...
class VSaveDialog : public CBaseModFrame, public FlyoutMenuListener
{
	DECLARE_CLASS_SIMPLE( VSaveDialog, CBaseModFrame );

public:
	VSaveDialog(vgui::Panel *parent, const char *panelName);
	~VSaveDialog();
