...
PRECACHE_REGISTER_BEGIN( GLOBAL, VBaseSaveGameDialog )
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CVBaseSaveGameDialog::CVBaseSaveGameDialog( vgui::Panel *parent, const char *name ) : BaseClass( parent, name )
{
	...
	LoadControlSettings( "resource/ui/basemodui/SaveGame.res" );
...
//=============================================================================
CVBaseSaveGameDialog::~CVBaseSaveGameDialog()
{
...
// Input  : *command - 
//-----------------------------------------------------------------------------
void CVBaseSaveGameDialog::OnCommand( const char *command )
{
...
//-----------------------------------------------------------------------------
void CVBaseSaveGameDialog::CreateSavedGamesList()
{
...
//-----------------------------------------------------------------------------
int CVBaseSaveGameDialog::GetSelectedItemSaveIndex()
{
	CSaveGamePanel *panel = dynamic_cast<CSaveGamePanel *>(m_pGameList->GetSelectedPanel());
	if ( panel )
	{
...
//-----------------------------------------------------------------------------
void CVBaseSaveGameDialog::ScanSavedGames()
{
...
//-----------------------------------------------------------------------------
void CVBaseSaveGameDialog::AddSaveGameItemToList( int saveIndex )
{
...
//-----------------------------------------------------------------------------
bool CVBaseSaveGameDialog::ParseSaveData( char const *pszFileName, char const *pszShortName, SaveGameDescription_t &save )
{
...
/*
void CVBaseSaveGameDialog::OnNotifyChildFocus( vgui::Panel* child )
{
}

void CVBaseSaveGameDialog::OnFlyoutMenuClose( vgui::Panel* flyTo )
{
	UpdateFooter();
}

void CVBaseSaveGameDialog::OnFlyoutMenuCancelled()
{
}*/

//=============================================================================
Panel* CVBaseSaveGameDialog::NavigateBack()
{
	DevMsg(1, " !! Save Game Dialog: Navigatin back \n");
	return BaseClass::NavigateBack();
}
void CVBaseSaveGameDialog::UpdateFooter()
{
...
//-----------------------------------------------------------------------------
void CVBaseSaveGameDialog::DeleteSaveGame( const char *fileName )
{
...
//-----------------------------------------------------------------------------
void CVBaseSaveGameDialog::OnPanelSelected()
{
	SetControlEnabled( "loadsave", true );
}

//=============================================================================
void CVBaseSaveGameDialog::ApplySchemeSettings(vgui::IScheme *pScheme)
{
	BaseClass::ApplySchemeSettings(pScheme);
...
//-----------------------------------------------------------------------------
void CVBaseSaveGameDialog::FindSaveSlot( char *buffer, int bufsize )
{
	buffer[0] = 0;
	char szFileName[512];
...
//-----------------------------------------------------------------------------
void CVBaseSaveGameDialog::OnScanningSaveGames()
{
...
void CVBaseSaveGameDialog::AcceptSaveOverwriteCallback()
{
	if ( CVBaseSaveGameDialog *pSaveGameDialog = static_cast< CVBaseSaveGameDialog* >( CBaseModPanel::GetSingleton().GetWindow( WT_MAINMENU ) ) )
	{
		pSaveGameDialog->OnCommand( "SaveOverwriteConfirmed" );
	}
}