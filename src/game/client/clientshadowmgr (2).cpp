...
void CClientShadowMgr::CalculateRenderTargetsAndSizes( void )
{
	...
	m_nMaxDepthTextureShadows = 32;	// Just one shadow depth texture in games, more in tools
}
//-----------------------------------------------------------------------------
// Constructor
//-----------------------------------------------------------------------------
...
void CClientShadowMgr::InitRenderTargets()
{
	...
	{
		int nNumShadows = MAX_DEPTH_TEXTURE_SHADOWS;
		m_nLowResStart = MAX_DEPTH_TEXTURE_HIGHRES_SHADOWS;
