...
Scheme
{
	...
	Colors
	{
		...
		"LightBlue"			"192 192 192 255"//"66 142 192 255"
		"GreyBlue"			"65 65 65 255"//"65 74 96 255"
		"DarkBlueTrans"			"74 74 74 64"//"65 74 96 64"
		"Blue"				"148 148 148 255"//"83 148 192 255"
		"HighlightBlue"		"213 213 213 255"//"169 213 255 255"
	...
	// Custom styles for use with L4D360HybridButtons
		...
		HybridButton.BorderColor					"Gray"//"GreyBlue"
		HybridButton.BlotchColor					"DarkGrayLowAlpha"//"DarkBlueTrans"

		// These bypass all of CA's horrific style.  Look/Feel is code based
			
		// main or ingame menu only
		MainMenuButton.Style						"0"
		MainMenuButton.TextInsetY					"3"		[$WIN32]
